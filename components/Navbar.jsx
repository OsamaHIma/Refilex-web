    ...
    >
      ...
      >
        ...
        <section className="flexCenter relative">
          ...
          >
            <li
              className="cursor-pointer rounded-t-md px-8 pb-2 pt-4 text-slate-100 transition-all ease-in-out hover:bg-indigo-600 hover:text-gray-300 active:!bg-indigo-500"
            ...
            <li
              className="cursor-pointer py-2 pl-8 text-slate-100 transition-all ease-in-out hover:bg-indigo-600 hover:text-gray-300 active:!bg-indigo-500"
            ...
            <li
              className="cursor-pointer rounded-b-md pb-4 pl-8 pt-2 text-slate-100 transition-all ease-in-out hover:bg-indigo-600 hover:text-gray-300 active:!bg-indigo-500"
