export default function Loading() {
  return (
    <div
      className="relative flex h-screen flex-col items-center justify-center bg-slate-200 dark:bg-primary-black"
      dir="rtl"
    >
      ...
      <div className="mt-2 text-lg text-gray-900 dark:text-slate-300">
        Loading...
      </div>
    </div>
  );
